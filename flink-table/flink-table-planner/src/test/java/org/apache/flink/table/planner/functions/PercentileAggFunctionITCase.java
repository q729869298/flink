    ...
    private Stream<TestSpec> percentileTestCases() {
        return Stream.of(
                TestSpec.forFunction(BuiltInFunctionDefinitions.PERCENTILE)
                        ...
                        .testResult(
                                source ->
                                        "SELECT PERCENTILE(f0, ARRAY[0.9, 0.7, 0.3]), f2 FROM "
                                                + source
                                                + " GROUP BY f2",
                                TableApiAggSpec.groupBySelect(
                                        Collections.singletonList($("f2")),
                                        $("f0").percentile(new double[] {0.9, 0.7, 0.3}),
                                        $("f2")),
                                ROW(ARRAY(DOUBLE()), STRING()),
                                ROW(ARRAY(DOUBLE()), STRING()),
                                Arrays.asList(
                                        Row.of(new Double[] {9.0, 4.6, 1.4}, "A"),
                                        Row.of(new Double[] {6.0, 5.0, 2.5}, "B"),
                                        Row.of(new Double[] {2.0, 2.0, 2.0}, "C")))
                        .testResult(
                                source ->
                        ...
                        .testResult(
                                source ->
                                        "SELECT PERCENTILE(f0, ARRAY[0.9, 0.7, 0.3], f1), f2 FROM "
                                                + source
                                                + " GROUP BY f2",
                                TableApiAggSpec.groupBySelect(
                                        Collections.singletonList($("f2")),
                                        $("f0").percentile(new double[] {0.9, 0.7, 0.3}, $("f1")),
                                        $("f2")),
                                ROW(ARRAY(DOUBLE()), STRING()),
                                ROW(ARRAY(DOUBLE()), STRING()),
                                Arrays.asList(
                                        Row.of(new Double[] {9.0, 5.0, 2.0}, "A"),
                                        Row.of(new Double[] {6.0, 6.0, 4.4}, "B"),
                                        Row.of(new Double[] {2.0, 2.0, 2.0}, "C"))),
                TestSpec.forFunction(BuiltInFunctionDefinitions.PERCENTILE)
