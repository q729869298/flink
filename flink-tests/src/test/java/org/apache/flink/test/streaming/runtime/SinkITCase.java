...
class SinkITCase extends AbstractTestBase {
     ...
     * recovers and handles multiple EndOfInput().
     */
    @Test
    void testDuplicateEndOfInput() throws Exception {
        ...
        FailingCommitter committer =
                new FailingCommitter(sharedObjects.add(failedOnce), sharedObjects.add(committed));
